    ...
    <div className='text-left'>
      ...
      <div className="mt-2">
        ...
        >
          ...
          <option value="administrador" className='bg-gray-100 text-black'>Administrador de fincas</option>
          <option value="moderador" className='bg-gray-100 text-black'>Moderador</option>
        </select>
      </div>
    </div>);
};
